            ...
            <div class="row">
                <div class="col-3 px-1">
                	<a class="nav-link" onclick="location.href='home.jsp'">
                		<img src="logo.jpg" alt="logo" class="img-fluid" style="max-width: 165px;">
                	</a>
                </div>
                <div class="col-4"></div>
	                      ...
	                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
	                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	                          ...
	                          <li class="nav-item dropdown">
	                            ...
	                            <ul class="dropdown-menu bg-shadow">
	                              <li><a class="dropdown-item text-light" onclick="location.href='ManageUser'" >List of user</a></li>
	                              <li><a class="dropdown-item text-light" onclick="location.href='AddUser'" >Add user</a></li>
	                            </ul>
	                          </li>
	                        </ul>
	                      </div>
